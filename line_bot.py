...
def build_help_message():
    return (
        ...
        "AI Assistant\n"
        "ถามอะไรก็ได้\n\n"
        "👉 พิมพ์ชื่อเมนู เช่น เอกสาร หรือ การเงิน"
    )
...
def build_submenu_message(category: str) -> str:
    ...
    if cat in {"เอกสาร", "สรุปเอกสาร", "document", "📄"}:
        return (
            ...
            "📝\n"
            "'สรุปเอกสาร'\n\n"
            "สรุปชีทเรียน / รายงาน / วิจัย (มี 5 โหมด)\n\n"
            "🧾\n"
            "'สรุปใบเสร็จ'\n\n"
            "อ่านและสรุปข้อมูลบิล / ใบเสร็จรับเงิน\n\n"
            "💡 ทิป: หากต้องการทำ PDF หรือจัดรูปใส่ A4 พิมพ์ 'รูปภาพ'\n\n"
        ...
        return (
            ...
            "📲\n"
            "'ส่งสลิปตรงๆ'\n\n"
            "ส่งรูปสลิปเข้ามาเพื่ออ่านยอดเงินอัตโนมัติ\n\n"
            "📊\n"
            "'ดูสลิปทั้งหมด' / 'ยอดรวมสลิป'\n\n"
            "ดูรายการและผลรวมยอดสลิปครั้งล่าสุด\n\n"
            "🔍\n"
            "'สลิปที่ [เลข]'\n\n"
            "ขอดูข้อมูลรายละเอียดแยกแต่ละใบ (เช่น 'สลิปที่ 1')\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับหน้าหลัก\n"
            "👉 พิมพ์ 'ยกเลิก' เพื่อหยุดงานปัจจุบัน"
        )
        ...
        return (
            ...
            "💰 การเงิน\n\n"
            "✍️\n"
            "'ค่าน้ำ 270' / 'เงินเดือน 15000'\n\n"
            "พิมพ์รายรับ-รายจ่ายตามสบายเพื่อบันทึก\n\n"
            "📊\n"
            "'สรุปเดือนนี้' / 'รายการล่าสุด'\n\n"
            "ดูรายงานสรุปการเงินและรายการล่าสุด\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับหน้าหลัก"
        )
        ...
        return (
            ...
            "📅 นัดหมาย & บันทึก\n\n"
            "📌\n"
            "'นัด [เรื่อง] [ปี-เดือน-วัน] [เวลา]'\n\n"
            "พิมพ์ตั้งรายการนัดหมายใหม่เพื่อเตือนความจำ\n\n"
            "📅\n"
            "'ดูนัดหมาย'\n\n"
            "เช็ครายการนัดหมายทั้งหมดที่จดไว้\n\n"
            "📝\n"
            "'บันทึก [ข้อความ]' / 'ดูบันทึก' / 'ลบบันทึก'\n\n"
            "จัดการข้อมูลบันทึกสั้น (Memo) ทั่วไป\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับหน้าหลัก"
        )
        ...
        return (
            ...
            "👤\n"
            "'ข้อมูลของฉัน'\n\n"
            "ดูข้อมูลส่วนตัวและประวัติการเงินของคุณ\n\n"
            "✏️\n"
            "'เปลี่ยนชื่อเป็น [ชื่อ]'\n\n"
            "แก้ไขชื่อในโปรไฟล์ระบบ\n\n"
            "🗑️\n"
            "'ล้างข้อมูลของฉัน'\n\n"
            "ลบข้อมูลโปรไฟล์และประวัติทั้งหมด\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับหน้าหลัก"
        )
        ...
        return (
            ...
            "🎤 เสียง & การถอดความ\n\n"
            "🎙️\n"
            "'ส่งเสียงพูด' / 'ไฟล์เสียง'\n\n"
            "ส่งไฟล์เสียง (.mp3, .wav, .m4a) หรืออัดเสียงพูดเข้ามา\n"
            "บอทจะแปลเป็นข้อความและสรุปให้ทันที\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับหน้าหลัก"
        )
        ...
        return (
            ...
            "💬\n"
            "'พิมพ์คุยทั่วไป'\n\n"
            "สอบถามและพูดคุยเรื่องทั่วไปกับ AI ได้ตลอดเวลา\n\n"
            "🔤\n"
            "'แปลเป็นอังกฤษ: [ข้อความ]'\n\n"
            "แปลคำศัพท์และประโยคเป็นภาษาอังกฤษ\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับหน้าหลัก"
        )
    return ""
