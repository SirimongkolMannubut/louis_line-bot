...
def build_submenu_message(category: str) -> str:
    ...
    if cat in {"เอกสาร", "สรุปเอกสาร", "document", "📄"}:
        return (
            "📄 เมนู: เอกสาร\n"
            "════════════════════\n"
            "• 'สรุปเอกสาร' → สรุปรูปชีท / PDF / Word (มี 5 โหมด)\n"
            "• 'สรุปใบเสร็จ' → สรุปบิลและค่าใช้จ่าย\n\n"
        ...
        return (
            "🧾 เมนู: สลิปโอนเงิน\n"
            "════════════════════\n"
            "• ส่งสลิปตรงๆ → อ่านยอดเงินทันที\n"
            "• 'ดูสลิปทั้งหมด' / 'ยอดรวมสลิป'\n"
            "• 'สลิปที่ 1', 'สลิปที่ 2' → ดูแยกใบ\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับไปหน้าหลัก\n"
            "👉 พิมพ์ 'ยกเลิก' เพื่อหยุดงานปัจจุบัน"
        )
        ...
        return (
            "💰 เมนู: การเงิน\n"
            "════════════════════\n"
            "• พิมพ์บันทึกตรงๆ ได้เลย เช่น 'ค่าน้ำ 270' หรือ 'เงินเดือน 15000'\n"
        ...
        return (
            "📅 เมนู: นัดหมาย & บันทึก\n"
            "════════════════════\n"
            "• 'นัด [เรื่อง] [ปี-เดือน-วัน] [เวลา]' → ตั้งเตือนนัด\n"
            "• 'ดูนัดหมาย' → เช็ครายการนัดทั้งหมด\n"
        ...
        return (
            "👤 เมนู: โปรไฟล์ของฉัน\n"
            "════════════════════\n"
            "• 'ข้อมูลของฉัน' → ดูประวัติ ชื่อ อายุ อาชีพ\n"
            "• 'เปลี่ยนชื่อเป็น [ชื่อ]'\n"
            "• 'ล้างข้อมูลของฉัน' → ลบประวัติทั้งหมดออกจากระบบ\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับไปหน้าหลัก"
        )
        ...
        return (
            "🖼️ เมนู: รูปภาพ\n"
            "════════════════════\n"
            "• 'ทำ PDF' → รวมรูปภาพถ่ายเป็นไฟล์ PDF\n"
            "• 'จัดรูปลง A4' → จัดรูปถ่ายใส่กระดาษ A4 PDF\n"
            "• 'ย่อรูป' → ลดขนาดไฟล์รูปทันที (ลด KB/MB)\n\n"
        ...
        return (
            ...
            "════════════════════\n"
            "• ส่งไฟล์เสียง (.mp3, .wav, .m4a) หรืออัดเสียงพูดเข้ามาได้เลย\n"
            "  บอทจะแปลงเป็นข้อความและสรุปให้ทันที\n\n"
            "👉 พิมพ์ 'เมนู' เพื่อกลับไปหน้าหลัก"
        )
        ...
        return (
            "🌐 เมนู: AI Assistant\n"
            "════════════════════\n"
            "• พิมพ์คุยทั่วไป หรือถามอะไรก็ได้กับ AI\n"
